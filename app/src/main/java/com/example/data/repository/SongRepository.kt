...
class SongRepository(private val songDao: SongDao) {
    ...
    suspend fun checkAndPrepopulate(context: Context) = kotlinx.coroutines.withContext(kotlinx.coroutines.Dispatchers.IO) {
        try {
    ...
    suspend fun updateSongDownloadStatus(songId: Int, isDownloaded: Boolean, filePath: String?) {
        songDao.updateDownloadStatus(songId, isDownloaded, filePath)
    }
}
